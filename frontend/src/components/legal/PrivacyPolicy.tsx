...
const PrivacyPolicy = () => {
  return (
    <div className='PrivacyPolicy'>
      <h3>IT&rsquo;S ON, LLC PRIVACY POLICY</h3>
      <p>
        It&rsquo;s On, LLC (the &ldquo;Company&rdquo;) is committed to
        maintaining robust privacy protections for its users. Our Privacy Policy
        (&ldquo;Privacy Policy&rdquo;) is designed to help you understand how we
      ...
      <p>
        ...
        Company&rsquo;s website, which can be accessed at https://itson.fyi or
        through our mobile application.
      </p>
      <p>
        &ldquo;Service&rdquo; refers to the Company&rsquo;s services accessed
        via the Site, in which users can create channels to share with others in
        order to let them know when events are happening.&nbsp;
      </p>
      <p>
      ...
      <p>
        ...
        Terms of Use (found here: https://itson.fyi/terms), and you consent to
        our collection, storage, use and disclosure of your Personal Information
        as described in this Privacy Policy.
      </p>
      <h4>I. INFORMATION WE COLLECT</h4>
      <p>
        We collect &ldquo;Non-Personal Information&rdquo; and &ldquo;Personal
        Information.&rdquo; <strong>Non-Personal Information</strong> includes
        ...
        number of clicks. <strong>Personal Information</strong> includes your
        email address, username, and optionally, a profile image, which you
        submit to us through the registration process at the Site.
      </p>
      <ol>
        <li>
          {' '}
      ...
      <p>
        ...
        came from (known as the &ldquo;referring URL&rdquo;), the type of
        browser you use, the device from which you connected to the Service, the
        time and date of access, and other information that does not personally
        identify you. We track this information using cookies, or small text
        files which include an anonymous unique identifier. Cookies are sent to
        a user&rsquo;s browser from our servers and are stored on the
        ...
        services, both on an individual and aggregate basis. For example, the
        Company may use cookies to collect the following information:
      </p>
      <ul>
        <li>Whether the user is logged in or not</li>
      ...
      <ol start={3}>
        <li>
          <em>Children&rsquo;s Privacy</em>
        </li>
      </ol>
      <p>
      ...
      <p>
        ...
        emails from us. Those vendors use your Personal Information only at our
      ...
      <p>
        ...
        communications from us in the &ldquo;Settings&rdquo; section of the
        Site. Please note that notwithstanding the promotional preferences you
        indicate by either unsubscribing or opting out in the
        &ldquo;Settings&rdquo; section of the Site, we may continue to send you
      ...
      <h4>Last Updated</h4>
      <p>This Privacy Policy was last updated on February 22, 2024.</p>
    </div>
  )
}
