...
const TermsOfUse = () => {
  return (
    <div className='TermsOfUse'>
      ...
      <p>
        <strong>Last revised on: February 22, 2024</strong>
      </p>
      <br />
      <p>
        The website located at itson.fyi (the &ldquo;
        <strong>Site</strong>
        &rdquo;) is a copyrighted work belonging to It&apos;s On, LLC (&ldquo;
        ...
        &rdquo;, and &ldquo;
        <strong>we</strong>
        &rdquo;).&nbsp; Certain features of the Site may be subject to
      ...
      <p>
        THESE TERMS OF USE (THESE &ldquo;
        <strong>TERMS</strong>
        &rdquo;) SET FORTH THE LEGALLY BINDING TERMS AND CONDITIONS THAT GOVERN
      ...
      <p>
        <strong>PLEASE BE </strong>
        <strong>AWARE</strong>
        <strong> THAT SECTION 10.2 </strong>
        <strong>
        ...
        <strong>AND</strong>
        <strong> FINAL ARBITRATION.&nbsp; SECTION </strong>
        <strong>10.2</strong>
        <strong>
          {' '}
        ...
        <strong>10.2</strong> <strong>CAREFULLY</strong>
        <strong>.</strong>
      </p>
      <p>
        <strong>
      ...
      <ul>
        <li>
          ...
          &rdquo;) and provide certain information about yourself as prompted by
      ...
      <ul>
        <li>
          ...
          Account or any other breach of security.&nbsp; Company cannot and will
      ...
      <ul>
        <li>
          ...
          its content are owned by Company or Company&rsquo;s suppliers.&nbsp;
      ...
      <ul>
        <li>
          ...
          regarding the Site (&ldquo;
          <strong>Feedback</strong>
          &rdquo;), you hereby assign to Company all rights in such Feedback and
      ...
      <ul>
        <li>
          ...
          &nbsp; &ldquo;
          <strong>User Content</strong>
          &rdquo; means any and all information and content that a user submits
          to, or uses with, the Site (e.g., content in the user&rsquo;s profile
          ...
          Use Policy.&nbsp; Company is not obligated to backup any User Content,
          and your User Content may be deleted at any time without prior
          notice.&nbsp; You are solely responsible for creating and maintaining
      ...
      <ul>
        <li>
          ...
          The following terms constitute our &ldquo;
          <strong>Acceptable Use Policy</strong>
          &rdquo;:
        </li>
      </ul>
      <ul>
        <li>
          ...
          abusive, tortious, threatening, harmful, invasive of another&rsquo;s
      ...
      <ul>
        <li>
          ...
          or interfere with any other user&rsquo;s use and enjoyment of the
      ...
      <ul>
        <li>
          ...
          Content.&nbsp; Company reserves the right, at your expense, to assume
          ...
          prior written consent of Company.&nbsp; Company will use reasonable
      ...
      <ul>
        <li>
          ...
          and/or display advertisements for third parties (collectively, &ldquo;
          <strong>Third-Party Links &amp; Ads</strong>
          &rdquo;).&nbsp; Such Third-Party Links &amp; Ads are not under the
          ...
          Third-Party Links &amp; Ads, the applicable third party&rsquo;s terms
          and policies apply, including the third party&rsquo;s privacy and data
      ...
      <ul>
        <li>
          ...
          1542 IN CONNECTION WITH THE FOREGOING, WHICH STATES: &ldquo;A GENERAL
      ...
      <p>
        ...
        If you believe that one of our users is, through the use of our Site,
        ...
        form of a written notification (pursuant to 17 U.S.C. &sect; 512(c))
      ...
      <p>
        ...
        damages, costs and attorney&rsquo;s fees incurred by us in connection
        with the written notification and allegation of copyright infringement.
      </p>
      <p>&nbsp;</p>
      <p>The designated Copyright Agent for Company is:</p>
      <p>
        Designated Agent: Copyright Compliance Department @ It&rsquo;s On, LLC
      </p>
      <p>
        Address of Agent: 2261 Market Street STE 10055 San Francisco,&nbsp;
        CA&nbsp; 94114
      </p>
      <p>Telephone: 6502090285</p>
      <p>Email: dmca@itson.fyi</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <ul>
        <li>
      ...
      <ul>
        <li>
          <strong>Dispute Resolution.</strong> Please read the following
          arbitration agreement in this Section (the &ldquo;
          <strong>Arbitration Agreement</strong>
          &rdquo;) carefully.&nbsp; It requires you to arbitrate disputes with
          ...
          employees, agents, and representatives (collectively, the &ldquo;
          <strong>Company Parties</strong>
          &rdquo;) and limits the manner in which you can seek relief from the
          Company Parties
          <em>.</em>
          &nbsp;
        </li>
      ...
      <ul>
        <li>
          ...
          &rdquo;) or these Terms will be resolved by binding arbitration,
          ...
          <strong>
            ...
            all claims that arose or were asserted before you agreed to these
            Terms (in accordance with the preamble) or any prior version of
            these Terms.
          </strong>
          ...
          Parties on your behalf.&nbsp; For purposes of this Arbitration
          Agreement, &ldquo;
          <strong>Dispute</strong>
          &rdquo; will also include disputes that arose or involve facts
      ...
      <ul>
        <li>
          ...
          and mutually beneficial outcome. You and Company therefore agree that
          ...
          this Arbitration Agreement (&ldquo;
          <strong>Informal Dispute Resolution Conference</strong>
          &rdquo;). If you are represented by counsel, your counsel may
      ...
      <p>
        ...
        &rdquo;), which shall occur within 45 days after the other party
        ...
        contact@itson.fyi, or by regular mail to 2261 Market Street, STE 10055,
        San Francisco, California 94114. The Notice must include: (1) your name,
      ...
      <p>
        ...
        initiating party&rsquo;s Dispute. Engaging in the Informal Dispute
      ...
      <ul>
        <li>
          <strong>
            <strong>&nbsp;</strong>
            <strong>Arbitration Rules and Forum.</strong>
            ...
            above does not resolve satisfactorily within 60 days after receipt
            of your Notice, you and Company agree that either party shall have
            ...
            and enforcement of this Arbitration Agreement. The arbitration will
            be conducted by JAMS, an established alternative dispute resolution
            provider. Disputes involving claims and counterclaims with an amount
            in controversy under $250,000, not inclusive of attorneys&rsquo;
            fees and interest, shall be subject to JAMS&rsquo; most current
            ...
            JAMS at 800-352-5267. A party who wishes to initiate arbitration
            must provide the other party with a request for arbitration (the
            &ldquo;
            <strong>Request</strong>
            &rdquo;). The Request must include: (1) the name, telephone number,
            mailing address, e‐mail address of the party seeking arbitration and
            the account username (if applicable) as well as the email address
      ...
      <p>
        ...
        counsel&rsquo;s knowledge, information, and belief, formed after an
      ...
      <p>
        ...
        shared with anyone except the parties&rsquo; attorneys, accountants, or
      ...
      <ul>
        <li>
          <strong>
            <strong>Authority of Arbitrator.</strong> The arbitrator shall have
            ...
            relating to the subsection entitled &ldquo;Waiver of Class or Other
            ...
            Non-Individualized Relief&rdquo; is unenforceable, illegal, void or
            voidable, or that such subsection entitled &ldquo;Waiver of Class or
            Other Non-Individualized Relief&rdquo; has been breached, shall be
            decided by a court of competent jurisdiction and not by an
            arbitrator; (2) except as expressly contemplated in the subsection
            entitled &ldquo;Batch Arbitration,&rdquo; all Disputes about the
            ...
            arbitrator.&nbsp; The arbitration proceeding will not be
            ...
            &ldquo;Batch Arbitration.&rdquo; The arbitrator shall have the
            ...
            forum&rsquo;s rules, and these Terms (including the Arbitration
            ...
            shall follow the applicable law. The award of the arbitrator is
      ...
      <ul>
        <li>
          ...
          &nbsp;EXCEPT AS SPECIFIED IN SECTION 10.2(A) &nbsp; YOU AND THE
          COMPANY PARTIES HEREBY WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS
          TO SUE IN COURT AND H AVE A TRIAL IN FRONT OF A JUDGE OR A JURY. You
          and the Company Parties are instead electing that all covered claims
          and disputes shall be resolved exclusively by arbitration under this
          Arbitration Agreement, except as specified in Section 10.2(a) above.
      ...
      <ul>
        <li>
          ...
          AN INDIVIDUAL BASIS AND NOT ON A CLASS, REPRESENTATIVE, OR COLLECTIVE
          ...
          relief warranted by the party&rsquo;s individual claim. Nothing in
          this paragraph is intended to, nor shall it, affect the terms and
          conditions under the Subsection 10.2(h) entitled &ldquo;Batch
          Arbitration.&rdquo; Notwithstanding anything to the contrary in this
          ...
          limitations of this subsection, &ldquo;Waiver of Class or Other
          Non-Individualized Relief,&rdquo; are invalid or unenforceable as to a
      ...
      <ul>
        <li>
          <strong>Attorneys&rsquo; Fees and Costs.</strong> The parties shall
          bear their own attorneys&rsquo; fees and costs in arbitration unless
          the arbitrator finds that either the substance of the Dispute or the
          ...
          Rule of Civil Procedure 11(b)). If you or Company need to invoke the
          authority of a court of competent jurisdiction to compel arbitration,
          then the party that obtains an order compelling arbitration in such
          action shall have the right to collect from the other party its
          reasonable costs, necessary disbursements, and reasonable
          attorneys&rsquo; fees incurred in securing an order compelling
          ...
          and reasonable attorneys&rsquo; fees and costs.
        </li>
      </ul>
      <ul>
        <li>
          ...
          shall (1) administer the arbitration demands in batches of 100
          Requests per batch (plus, to the extent there are less than 100
          Requests left over after the batching described above, a final batch
          consisting of the remaining Requests); (2) appoint one arbitrator for
          each batch; and (3) provide for the resolution of each batch as a
      ...
      <p>&nbsp;</p>
      <p>
        All parties agree that Requests are of a &ldquo;substantially similar
        nature&rdquo; if they arise out of or relate to the same event or
        ...
        process (&ldquo;
        <strong>Administrative Arbitrator</strong>
        &rdquo;). In an effort to expedite resolution of any such dispute by the
        ...
        disputes promptly. The Administrative Arbitrator&rsquo;s fees shall be
        paid by Company.
      </p>
      <p>
      ...
      <ul>
        <li>
          <strong>
            ...
            decision to opt out to the following address: 2261 Market Street,
            STE 10055, San Francisco, California 94114, or email to
            contact@itson.fyi, within 30 days after first becoming subject to
      ...
      <ul>
        <li>
          <strong>Invalidity, Expiration.</strong> Except as provided in the
          subsection entitled &ldquo;Waiver of Class or Other Non-Individualized
          Relief&rdquo;, if any part or parts of this Arbitration Agreement are
          found under the law to be invalid or unenforceable, then such specific
          part or parts shall be of no force and effect and shall be severed and
          the remainder of the Arbitration Agreement shall continue in full
          force and effect. You further agree that any Dispute that you have
          with Company as detailed in this Arbitration Agreement must be
          initiated via arbitration within the applicable statute of limitation
          for that claim or controversy, or it will be forever time barred.
          Likewise, you agree that all applicable statutes of limitation will
      ...
      <ul>
        <li>
          ...
          address: 2261 Market Street, STE 10055, San Francisco, California
          94114, or email to contact@itson.fyi.&nbsp; Unless you reject the
      ...
      <ul>
        <li>
          ...
          &ldquo;including without limitation&rdquo;.&nbsp; If any provision of
          ...
          will be null and void.&nbsp; Company may freely assign these
      ...
      <ul>
        <li>
          ...
          .&nbsp; Copyright &copy; 2024 It&apos;s On, LLC. All rights
          reserved.&nbsp; All trademarks, logos and service marks (&ldquo;
          <strong>Marks</strong>
          &rdquo;) displayed on the Site are our property or the property of
      ...
      <p>&nbsp;</p>
      <p>It&rsquo;s On, LLC</p>
      <p>Address:&nbsp;</p>
      <p>2261 Market Street</p>
      <p>STE 10055</p>
      <p>San Francisco, California 94114</p>
      <p>Telephone: 6502090285</p>
      <p>Email: contact@itson.fyi</p>
      <p>
        <br />
        <br />
      </p>
